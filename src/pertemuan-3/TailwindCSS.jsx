export default function TailwindCSS() {
  return (
    <div>
      <h1 class="border p-2 m-4">Belajar Tailwind CSS 4</h1>
      <button
...
function Typography(){
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold text-blue-600">Tailwind Typography</h1>
...
function BorderRadius(){
    return (
        <button className="border-3 border-blue-500 text-blue-500 ml-4 px-4 py-2 rounded-lg hover:shadow-md"> Klik Saya </button>
    )
}
