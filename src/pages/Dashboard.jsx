          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col items-center">
              <div className="relative w-28 h-28 rounded-full bg-red-100 flex items-center justify-center">
                <div className="absolute w-20 h-20 bg-white rounded-full flex items-center justify-center text-sm font-bold">81%</div>
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-28 h-28 rounded-full bg-green-100 flex items-center justify-center">
                <div className="absolute w-20 h-20 bg-white rounded-full flex items-center justify-center text-sm font-bold">22%</div>
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-28 h-28 rounded-full bg-blue-100 flex items-center justify-center">
                <div className="absolute w-20 h-20 bg-white rounded-full flex items-center justify-center text-sm font-bold">62%</div>
              </div>
